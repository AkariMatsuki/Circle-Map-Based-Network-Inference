...
def brusselator(t, X, A, B, d, conmat):
    '''
    X: x1,x2,..,xN, y1, y2,..., yN
    A: array with (N,)
    B: array with (N,)
...
def simulation_brusselator(y_init, tau, sim_time, A, B, d, conmat, sigma):
...
############# Simulation #############
y_init0 = np.append(A0 , B0)
tau0 = 0.01
sim_time0 = 300000
result0 = simulation_brusselator(y_init0, tau0, sim_time0, A0, B0, d0, con_mat0, sigma0)
######################################
